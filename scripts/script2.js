...
//checking if the user has entered anything within 'monthly input' 
monthly.addEventListener("keyup", (e)=>{
    check()
});
...
function check(){
    if((principle.value == "") || (interest.value == "") || (duration.value == "") || (monthly.value == "")){
        disabled();
    } else {
        unDisableBtn();
    }
